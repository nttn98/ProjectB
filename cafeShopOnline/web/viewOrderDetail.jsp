    ...
    <body style="background-image: url(images/product-bg.png);">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                    <a href="LoginServlet?mode=homeOnly"><img src="images/logo.png"></a><span class="text-logo">Ordered by: <%=selectedOrder.getCustomerName()%></span>
                </div>
            </div>
        </div>
        <div class="wrap cf">
            ...
            <div class="subtotal cf">
                <ul>
                    ...
                    <li class="totalRow"><a href="OrderServlet?mode=manage" class="btn continue">Back</a></li>
                </ul>
            </div>
        </div>
