    ...
    <body>
        ...
        <header>
            <div class="topHeader">
                <div class="container">
                    <nav class="menu">
                        <div class="mobileMenu d-block d-xl-none">
                            <ul class="wrapper">
                                <li>
                                    <span class="button-menu"><i class="fa fa-align-justify"></i></span>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                                ...
                                <div class="product">
                                    <div class="card" style="width: 18rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-price"><%=(int) listProduct.get(i).getProductPrice()%>.000 đ
                                            </p>
                                            <a
                            ...
                            <div class="col-12" style="text-align: center">
                                ...
                                <br>
                                <a href="LoginServlet?mode=product" style="text-decoration: none; color: white">
                                    <button type="button" class="btn btn-outline-success" style="text-align: center">Xem tất cả sản phẩm >></button>
                                </a>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <div class="subHotline">
                                                            <div class="media">
                                                                ...
                                                                <div class="media-body">
                                                                    <p>HOTLINE 24/7</p>
                                                                    <p class="phone-number">090.111.6688</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $(".topHeader .mobileMenu .wrapper .button-menu").click(function () {
                    $(".mobile-nav").show("slow");
                });
                $(".topHeader .mobileMenu .wrapper li span.del").click(function () {
