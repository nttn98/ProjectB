                ...
                <div class="container">
                    <div class="list-reasons">
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img src="images/discount1.jpg" alt="Discount1" class="discountImg" />
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img src="images/discount2.jpg" alt="Discount2" class="discountImg" />
                            </div>
                            <div class="col-12">
                                <hr color="#FFFFFF" width="70px" align="center"
                                    style="height: 1px;">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img src="images/discount3.jpg" alt="Discount3" class="discountImg" />
                            </div>
                        </div>
                    </div>
                </div>
