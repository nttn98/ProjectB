                ...
                <div class="container">
                    <div class="list-reasons">
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img class="news" src="images/coffeeandbrain.jpg" alt="Brain"  />
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img class="news" src="images/cafephamay.jpg" alt="Phamay"  />
                            </div>
                            <div class="col-12">
                                <hr color="white" width="70px" align="center"
                                    style="height: 1px;">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img class="news" src="images/trend.jpg" alt="Trend"  />
                            </div>
                        </div>
                    </div>
                </div>
