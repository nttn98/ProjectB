                ...
                <nav class="menu">
                    <div class="row">
                        <div class="col-12 col-xl-2 col-sm-12 col-md-12 col-lg-12">
                            <a href=""><img src="images/logo.png" alt="Vie-logo" class="logo"></a>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="information-Product">
                            ...
                            <br>
                            <a href= "CartServlet?mode=addCartItem&productId=<%=selectedProduct.getProductId()%>" style="text-decoration: none; color: white"><button class="btn btn-success">Order</button></a>
                            <a href="LoginServlet?mode=homeOnly"><button class="btn btn-success">Back</button></a>
                        </div>
                    </div>
                </div>
            </div>
