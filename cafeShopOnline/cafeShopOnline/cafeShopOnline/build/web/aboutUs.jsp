                ...
                <div class="container">
                    <div class="list-reasons">
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img src="images/khoinguon.jpg" alt="Khoinguon" width="700" height="400" />
                            </div>
                             <div class="col-12">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img src="images/dichvu.jpg" alt="Dichvu" width="700" height="400" />
                            </div>
                             <div class="col-12">
                                <hr color="white" width="70px" align="center"
                                    style="height: 1px;">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img src="images/doitac.jpg" alt="Doitac" width="700" height="400" />
                            </div>
                        </div>
                    </div>
                </div>
