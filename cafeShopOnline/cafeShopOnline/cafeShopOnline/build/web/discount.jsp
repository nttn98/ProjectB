            ...
            <div class="topMain">
                <div class="container">
                    <div class="list-reasons">
                        <div class="row">
                             <div class="col-12">
                                <h2 class="content">Danh mục: Khuyến mãi</h2>
                                ...
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title-2">Mua 1 tặng 100</h5>
                                                <p class="hankhuyenmai">Từ ngày 00/00/0000 đến 00/00/0000</p>
                                                <p class="card-text">Khi mua 1kg cà phê (bất kì) bạn sẽ ngay lập tức nhận được 1 gói 100 gr cùng loại (Ưu đãi cho đến khi hết hàng)</p>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img src="images/discount1.jpg" alt="Discount1" width="700" height="400" />
                            </div>
                                                         <div class="col-12">
                                <hr color="#FFFFFF" width="70px" align="center"
                                    style="height: 1px;">
                            </div>
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title-2">Giảm giá đến 50% </h5>
                                                <p class="hankhuyenmai">Từ ngày 00/00/0000 đến 00/00/0000</p>
                                                <p class="card-text">Giảm giá các sản phẩm trong danh sách với mức giảm giá lên đến 50% (Khi mua từ 2 sản phẩm trở lên)</p>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img src="images/discount2.jpg" alt="Discount2" width="700" height="400" />
                            </div>
                                                         <div class="col-12">
                                <hr color="#FFFFFF" width="70px" align="center"
                                    style="height: 1px;">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title-2">Giảm giá đến 75%</h5>
                                                <p class="hankhuyenmai">Từ ngày 00/00/0000 đến 00/00/0000</p>
                                                <p class="card-text">Nhân dịp tưng bừng khai trương chi nhánh mới, khi khách hàng dến với chi nhánh Vie Deli Sao Chổi quý khách sẽ được mua hàng ưu đãi lên đến 75%</p>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img src="images/discount3.jpg" alt="Discount3" width="700" height="400" />
                            </div>
                        </div>
                    </div>
                </div>
