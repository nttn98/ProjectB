                            ...
                            <div class="col col-lg-10">
                                <div class="desktopMenu">
                                    <ul class="list">
                                        ...
                                        <li class="item-desktop-menu"><a href="product.jsp">Sản phẩm</a></li>
            ...
            <div class="topMain">
                <div class="container">
                    <div class="list-reasons">
                        <div class="row">
                             <div class="col-12">
                                <h2 class="content">Danh mục: Tin tức</h2>
                                ...
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title">Tác dụng bất ngờ của cà phê</h5>
                                                <p class="card-text">Cà phê có tốt cho não không? Nhóm nghiên cứu của GS Andrew Scholey, Trung tâm Nghiên cứu Nhận thức và Khoa học nơron thuộc Đại học Northrumbia (Anh), khẳng định là rất tốt. Bởi trong hạt cà phê cafein chiếm 1 – 2%, có tác dụng kích thích thần kinh, tăng sức làm việc của trí óc.</p>                                                
                                            </div>                                           
                                        </div>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img class="news" src="images/coffeeandbrain.jpg" alt="Brain" width="700" height="400" />
                            </div>
                             <div class="col-12">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title">Cà Phê phin hay pha máy ?</h5>
                                                <p class="card-text">Cà phê pha phin được xem như đây là nét đẹp văn hóa ở Việt Nam. Vì đa số mọi người trước đây thường ưa chuộng sử dùng cách này. Nhưng hiện nay, cà phê pha máy đang được du nhập vào Việt Nam trong nhiều năm gần đây và cộng đồng yêu cà phê trong nước đón nhận tích cực. Mỗi ly cà phê được pha bằng những cách pha khác nhau thì đều có những ưu nhược điểm nhất định. Vậy việc pha máy hay pha phin sẽ ngon hơn?</p>                                                
                                            </div>                                           
                                        </div>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img class="news" src="images/cafephamay.jpg" alt="Phamay" width="700" height="400" />
                            </div>
                             <div class="col-12">
                                <hr color="white" width="70px" align="center"
                                    style="height: 1px;">
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title">Xu hướng kinh doanh cà phê hiện nay</h5>
                                                <p class="card-text">Ngoài việc mở quán cà phê sân vườn như truyền thống, các quán cà phê hiện nay đã biến tấu rất nhiều phù hợp với sở thích đa dạng hơn của khách hàng. Vậy xu hướng kinh doanh cà phê trong năm nay là gì? Mời bạn tham khảo qua bài viết dưới đây nhé!</p>                                                
                                            </div>                                           
                                        </div>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <img class="news" src="images/trend.jpg" alt="Trend" width="700" height="400" />
                            </div>
                        </div>
                    </div>
                </div>
