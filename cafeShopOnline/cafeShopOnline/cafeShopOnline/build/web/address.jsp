            ...
            <div class="topMain">
                <div class="container">
                    <div class="list-reasons">
                        <div class="row">
                             <div class="col-12">
                                <h2 class="content">Địa chỉ chi nhánh</h2>
                                ...
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card-2" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title">Vie Deli Sao hỏa</h5>
                                                <p class="card-text">Địa chỉ 1534, Quận 10, Phường 123, Sao Hỏa</p>
                                                <p class="card-phone">(027) 098137</p>
                                            </div>                                           
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card-2" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title">Vie Deli Sao Mộc</h5>
                                                <p class="card-text">Địa chỉ 1538, Quận 1, Phường 234, Sao Mộc</p>
                                                <p class="card-phone">(027) 098567</p>
                                            </div>                                           
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card-2" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title">Vie Deli Sao Kim</h5>
                                                <p class="card-text">Địa chỉ 34, Quận 11, Phường 345, Sao Kim</p>
                                                <p class="card-phone">(027) 098123</p>
                                            </div>                                           
                                        </div>
                                    </div>
                                </div>
                             ...
                             <div class="col-12">
                                ...
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card-2" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title">Vie Deli Sao Thủy</h5>
                                                <p class="card-text">Địa chỉ 1456, Quận 6, Phường 890, Sao Thủy</p>
                                                <p class="card-phone">(027) 098678</p>
                                            </div>                                           
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card-2" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title">Vie Deli Sao Chổi</h5>
                                                <p class="card-text">Địa chỉ 1534, Quận 10, Phường 123, Sao Chổi</p>
                                                <p class="card-phone">(027) 098137</p>
                                            </div>                                           
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                <div class="reason">
                                    <div class="card-group">
                                        <div class="card-2" style="width: 18rem;">
                                            <div class="card-body">
                                                <h5 class="card-title">Vie Deli Sao Xẹt</h5>
                                                <p class="card-text">Địa chỉ 1534, Quận 10, Phường 123, Sao Sao Xẹt</p>
                                                <p class="card-phone">(027) 098137</p>
                                            </div>                                           
                                        </div>
                                    </div>
