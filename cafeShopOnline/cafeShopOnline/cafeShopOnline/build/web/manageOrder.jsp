            ...
            <section class="ftco-section">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-12">
                            <a href="LoginServlet?mode=homeOnly"><img src="images/logo.png"></a><span class="text-logo">Manage Order</span>
                        </div>
                    </div>
                    <br>
                    <br>
                        ...
                        <table class="table" style="text-align: center">
                            ...
                            <tbody>
                                ...
                                <tr class="alert" role="alert">
                                    ...
                                    <td><a
                                            href="OrderServlet?mode=viewOrderDetail&orderId=<%=listOrder.get(i).getOrderId()%>"><button
                                                class="btn btn-info">View detail</button></a></td>
                                            <%if (listOrder.get(i).getOrderStatus() == 0) {%>
                                    <td><a
                                            href="OrderServlet?mode=orderCompleted&orderId=<%=listOrder.get(i).getOrderId()%>"><button
                                                class="btn btn-success">Completed</button></a></td>
                                            <%}
                                                    }
                                                }
                                            %>
